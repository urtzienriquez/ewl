...
*VD* stands for saturation vapor density and *T<sub>c</sub>* for temperature in degrees Celsius. The equation was taken from <a href="http://hyperphysics.phy-astr.gsu.edu/hbase/Kinetic/relhum.html#c3" target="_blank">hyperphysics.phy-astr.gsu.edu</a> .
